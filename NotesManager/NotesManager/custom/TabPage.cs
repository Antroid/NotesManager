...
namespace NotesManager.custom
{
    ...
    public class TabPage : TabbedPage
    {
        ...
        public static readonly BindableProperty BottomBarHeightProperty =
            BindableProperty.Create(nameof(BottomBarHeight), typeof(double), typeof(TabPage), 0d);
        ...
        public static readonly BindableProperty IsSelectionChangedProperty =
            BindableProperty.Create(nameof(IsSelectionChanged), typeof(bool), typeof(TabPage), false);
